package PartI_Exercise._4_NestedRectangles;
...
public class NestedRectangles {
    private static final TreeSet<Rectangle> rectangleSet = new TreeSet<>(Comparator.comparing(Rectangle::getX1)
    ...
    private static Rectangle getFirstRectangle() {
        Rectangle current = rectangleSet.first();
        int maxLayers = -1;
        for (Rectangle rectangle : rectangleSet) {
