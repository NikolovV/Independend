package _3_LinearDataStructures_ListAndDsComplexity.lab.arrayListTests;

import _3_LinearDataStructures_ListAndDsComplexity.lab.arrayList.ArrayList;
...
public class ArrayListTests {
    ...
    public void addSingleElementShouldIncreaseCount() {
        ...
        Assert.assertEquals(1, ArrayList.getCount());
    }
    ...
    public void addMultipleElementShouldIncreaseCount() {
        ...
        Assert.assertEquals(100, ArrayList.getCount());
    }
    ...
    public void setMultipleElements() {
        ...
        for (Integer i = 0; i < ArrayList.getCount(); i++) {
            list.set(i, i + 1);
        }
    ...
    public void removeMultipleElements() {
        ...
        Assert.assertEquals(50, ArrayList.getCount());
        for (int i = 0; i < 50; i++) {
    ...
    public void removeSingleElementShouldHaveCorrectCount() {
        ...
        Assert.assertEquals(0, ArrayList.getCount());
    }
