package _17_QuadKDIntervalTreesHashTables_Exercise._2_QuadTree;
...
public class QuadTreeTests {
    ...
    private static Rectangle GetSubquadrantBounds(int... quadrants) {
        int x = OriginX;
        int y = OriginY;
    ...
    public void TestMethod2() {
        ...
        Rectangle fourthQuadrant = QuadTreeTests.GetSubquadrantBounds(4);
    ...
    public void TestMethod3() {
        ...
        Rectangle firstQuadrant = QuadTreeTests.GetSubquadrantBounds(1);
        ...
        Rectangle secondQuadrant = QuadTreeTests.GetSubquadrantBounds(2);
        ...
        Rectangle thirdQuadrant = QuadTreeTests.GetSubquadrantBounds(3);
