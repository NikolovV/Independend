...
public class PTest18 {
    ...
    public void getAllInvoiceInPeriod_200000_elements() {
        ...
        Optional<Map.Entry<LocalDate, Long>> mostOccurrencesIssueDate = Generator.getMostOccurrences(invoices, Invoice::getIssueDate);
        Optional<Map.Entry<LocalDate, Long>> mostOccurrencesDueDate = Generator.getMostOccurrences(invoices, Invoice::getDueDate);
