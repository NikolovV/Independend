...
public class PTest09 {
    ...
    public void payInvoice_200000_elements() {
        ...
        List<Invoice> invoices = Generator.generateInvoices(200000);
        Optional<Map.Entry<LocalDate, Long>> mostOccurrences = Generator.getMostOccurrences(invoices, Invoice::getDueDate);
    ...
    static class Generator {
        ...
        static List<Invoice> generateInvoices(int count) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                LocalDate issueDate = LocalDate.ofEpochDay(Generator.getRandomDay(2010, 2015));
                LocalDate dueDate = LocalDate.ofEpochDay(Generator.getRandomDay(2018, 2020));
        ...
        static <T> Optional<Map.Entry<T, Long>> getMostOccurrences(List<Invoice> invoices, Function<Invoice, T> function) {
