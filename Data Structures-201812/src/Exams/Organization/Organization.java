...
public class Organization implements IOrganization {
    ...
    private final Set<Person> employeesSet;
    private final Map<String, List<Person>> employeesByName;
    private final TreeMap<Integer, List<Person>> employeesByNameLength;
    ...
    public void add(Person person) {
        ...
        this.employeesByNameLength.putIfAbsent(nameLength, new LinkedList<>());
