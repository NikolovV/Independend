...
public class Enterprise implements IEnterprise {
    ...
    private int count;
    private final Map<UUID, Employee> employeesByUUID;
    private final Map<String, List<Employee>> employeesByPosition;
    private final Map<String, List<Employee>> employeesByFirstName;
    private final TreeMap<Double, List<Employee>> employeesBySalary;
    private final TreeMap<Date, List<Employee>> employeesByHireDate;
    ...
    public boolean raiseSalary(int months, int percent) {
        ...
        Date toDate = new Date(2017, Calendar.AUGUST, 15);
